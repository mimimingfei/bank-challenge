...
describe('Account', () => {
  ...
  it("Test 8 should print the statement correctly when printStatement() is called", () => {
    ...
    expect(console.log).toHaveBeenCalledWith(jasmine.stringMatching('date           || credit || debit  || balance'));
    expect(console.log).toHaveBeenCalledWith(jasmine.stringMatching('10/01/2012 || 1000.00 ||        || 1000.00'));
    expect(console.log).toHaveBeenCalledWith(jasmine.stringMatching('13/01/2012 || 2000.00 ||        || 3000.00'));
    expect(console.log).toHaveBeenCalledWith(jasmine.stringMatching('14/01/2012 ||        || 500.00 || 2500.00'));
  });
