...
describe('Transaction',()=>{
    ...
    it('Test 1 should throw error when date format is not DD/MM/YYYY',()=>{
    ...
    it('Test 2 getDate() should return date format DD/MM/YYYY',()=>{
        const testTransaction = new Transaction("24/10/2023",0,0);
        expect(testTransaction.getDate()).toBe("24/10/2023");
    })
    it("Test 3 should throw error when deposit amount is not a number",()=>{
    ...
    it('Test 4 should throw error when deposit < 0',()=>{
        const testTransaction = new Transaction("01/02/2023",-100,0,);
        expect(() => {testTransaction.getDeposit()}).toThrowError(Error,"Input deposit should be a positive number");
    })
    it('Test 5 return deposit when getDeposit() is called',()=>{
        const testTransaction = new Transaction("02/02/2023",1000,0);
        expect(testTransaction.getDeposit()).toEqual(1000);
    })
    it("Test 6 should throw error when withdraw amount is not a number",()=>{
    ...
    it("Test 7 return withdrawal getWithdrawal() is called",()=>{
